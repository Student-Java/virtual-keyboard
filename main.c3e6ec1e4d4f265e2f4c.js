!function (e) {
  ...
  const r = {
    ...
    i = 10, o = 4, s = 'en', c = 'ru', u = ({id: e, width: t}) => {
      const n = document.createElement('div');
      return n.classList.add('button'), n.id = e, n.style.width = `${o * t}vw`, n.style.minWidth = `${i * t}px`, n.append(document.createElement('span')), n
    }, l = e => {
    ...
    }, d = {CapsLock: !1, shift: !1, ControlLeft: !1, lang: s, start: 0, end: 0}, p = document.querySelector('body'),
    ...
    if (r[e].special) (e => {
      ...
      switch (e) {
        ...
        case'ArrowRight':
          return d.start += 1, void (d.end = d.start);
        default:
          return void console.error('Unknown key code')
      }
      v(t);
      ...
      void 0 !== t && (v(t), d.start += 1, d.end = d.start)
    }
  };
  p.addEventListener('keydown', e => {
    const t = k(e);
    e.stopPropagation(), e.metaKey || e.preventDefault(), Object.keys(r).some(e => e === t) && ('Shift' === t ? d.shift = !0 : 'CapsLock' === t ? d.CapsLock = !d.CapsLock : 'ControlLeft' === t && (d.ControlLeft = !0), h(t), C(t), l(d))
  });
  p.addEventListener('keyup', e => {
    const t = k(e);
    Object.keys(r).some(e => e === t) && ((e => {
      d.shift && d.ControlLeft && ('Shift' === e || 'ControlLeft' === e) && (d.lang = d.lang === s ? c : s, K.setItem('lang', d.lang))
